...
* Windows :
    * édition avec SciTE :
        ...
        * [lien direct vers le zip](https://github.com/Microalg/Microalg/releases/download/v0.3.17/microalg_0.3.17.zip)
...
* Télécharger [ce zip](https://github.com/Microalg/Microalg/archive/v0.3.17.zip).
...
* MicroAlg
    * Télécharger [ce zip](https://github.com/Microalg/Microalg/releases/download/v0.3.17/microalg_0.3.17.zip).
...
[directement ici](https://github.com/Microalg/Microalg/releases/download/v0.3.17/microalg_0.3.17.zip).
