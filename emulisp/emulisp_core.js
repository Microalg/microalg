...
var coreFunctions = {
	...
	"js:eval": function(c) {
        ////eval("console.log(cst.context.processing_elt);");
        ////eval("console.log(processing_sketches);");
        ////eval("console.log(processing_sketches[cst.context.processing_elt]);");
        var src = valueToStr(evalLisp(c.car));
        eval(src);
        //console.log(src);
